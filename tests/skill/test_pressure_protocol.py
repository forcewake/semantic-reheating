...
def test_fake_selected_stack_runs_all_six_and_sanitizes_projection(
    ...
    task25_staged_allowed = {
        ...
        ".gitignore",
        "pyproject.toml",
        "tests/tools/test_domain_json_registry.py",
        "tests/tools/test_public_hygiene.py",
        "tests/tools/test_release_receipt.py",
        "tools/clean_checkout_verify.py",
        "tools/domain_json_registry.py",
    ...
    task28_staged_allowed = {
        ...
        "article/semantic-reheating/cover.svg",
        ...
        "tools/assets/fonts/LICENSE-DejaVu.txt",
    ...
    allowed = (
        ...
        | {
            ...
            "tests/live/test_results_metrics.py",
            "tests/live/test_results_privacy.py",
            "tests/live/test_campaign_executor.py",
            "tests/live/test_selected_campaign_artifacts.py",
